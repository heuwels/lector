      ...
      <div className="relative" ref={menuRef}>
        ...
        {isOpen && (
          <div
            ...
            className="absolute left-0 z-50 mt-1 w-44 rounded-lg border border-zinc-200 bg-white py-1 shadow-lg dark:border-zinc-700 dark:bg-zinc-800"
          >
            {allLangs.map((lang) => (
              <button
                role="option"
    ...
    <div className="relative mx-3" ref={menuRef}>
      ...
      {isOpen && (
        <div
          role="listbox"
          aria-label="Select language"
          className="absolute right-0 left-0 z-50 mt-1 rounded-lg border border-zinc-200 bg-white py-1 shadow-lg dark:border-zinc-700 dark:bg-zinc-800"
        >
          {allLangs.map((lang) => (
            <button
              role="option"
