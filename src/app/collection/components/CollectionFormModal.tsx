...
export default function CollectionFormModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent initialFocus={titleRef} className="flex max-w-lg flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-end gap-3 border-t border-border bg-muted px-6 py-4">
          ...
          <Button onClick={handleSave} disabled={isSaving || !title.trim() || !author.trim()}>
            {isSaving ? (
