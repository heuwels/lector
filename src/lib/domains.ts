...
// per-domain "strength band" maths. Mirrored verbatim in api/src/lib/domains.ts
// (the word-classifier prompt on the API side needs the same enum + scope
// hints) — keep the two files identical.
//
 ...
 * stays self-contained (and byte-identical to the API mirror).
 */
